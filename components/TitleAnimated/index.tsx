...
import { Container, Title, ContainerLogo, Logo } from './style'

function InitialAnimationTitle() {
    useAnimation()

    return (
        <Container id="title-animated">
            <Title>É HORA DE CONHECER SEU NOVO APÊ</Title>
...
export default InitialAnimationTitle