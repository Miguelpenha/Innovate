...
function MethodAnimated() {
    ...
    return (
        <Container id="method-animated">
            ...
            <Text className="text">Lorem ipsum dolor sit amet consectetur adipisicing elit. A fugiat commodi officia, et vero soluta deserunt eaque nisi fugit quae accusantium laudantium ipsa quo minima provident exercitationem esse fuga omnis!</Text>
            <Text className="text">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Asperiores ipsa unde obcaecati nobis, praesentium id in voluptatibus beatae dolore eligendi iure doloribus quaerat fuga tenetur nam autem repudiandae? Optio, quisquam?</Text>
            <Text className="text">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Consequatur reiciendis tenetur maiores nam. Quas esse saepe, doloribus id eum impedit, excepturi mollitia cum qui facilis rerum ex voluptatum minus! Beatae!</Text>
        </Container>
    )
}
